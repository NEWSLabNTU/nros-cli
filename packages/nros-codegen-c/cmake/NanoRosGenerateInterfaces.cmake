...
if(NOT DEFINED CACHE{_NANO_ROS_CODEGEN_TOOL})
  # Phase 195.D: the codegen tool is the canonical `nros` binary (`nros codegen …`).
  ...
  if(NOT _NANO_ROS_CODEGEN_TOOL)
    message(FATAL_ERROR
      "nros (codegen tool) not found. Pre-build it with:\n"
      "  cargo build --profile ${NROS_CODEGEN_CARGO_PROFILE} -p nros-cli\n"
